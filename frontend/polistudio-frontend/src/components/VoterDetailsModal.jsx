...
function VoterDetailsModal({ voter, onClose }) {
  ...
  return (
    <div style={modalOverlay}>
      <div style={modalContent}>
        ...
        <p>
          <strong>Age:</strong> {voter.age || 'Unknown'}
        </p>
        <p>
          <strong>Party:</strong> {voter.party || 'N/A'}
        </p>
        <p>
        ...
        <p>
          ...
          {voter.voting_history ? voter.voting_history.join(', ') : 'N/A'}
        </p>
        <p>
          <strong>Notes:</strong> {voter.notes || 'None'}
        </p>
